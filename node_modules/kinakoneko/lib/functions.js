...
module.exports = {
    ...
    lewdBomb: async function (n) { // Sends a bomb of random images of N value!
        ...
        if (n) {
            if (n > 20) throw new Error(`Kinako - lewdBomb(n) | The parameter you specified is above the maximum of 20!`);
            if (isNaN(n)) throw new Error(`Kinako - lewdBomb(n) | Parameter must be an integer!`);
